...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  ...
  '/txn-withdrawals': '%network_name% L3 to L2 message relayer',
  ...
  '/batches/[number]': '%network_name% L3 txn batch %number%',
  '/batches/celestia/[height]/[commitment]': '%network_name% L3 txn batch %height% %commitment%',
